...
//
// NOTE: these are file-scope functions. An earlier attempt inserted them
// inside init_setup() and broke /std/body.c outright, which locks every
// player out of the game including you. Commit before editing this file.
