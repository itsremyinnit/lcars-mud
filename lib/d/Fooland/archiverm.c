// This room lets you access the board archives in /d/Fooland/data/attic.
...
"various boards of this MUD.\n") ;
	set ("exits", ([ "south" : "/d/Fooland/tower1" ]) ) ;
	brd=clone_object("/std/board/archive");
    brd->set_attic_dir("/d/Fooland/data/attic");
 	brd->set_location("/d/Fooland/archiverm") ;
}
