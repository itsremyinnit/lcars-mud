// Meeting room A.
// Part of the TMI conference center.
...
void create() {
	::create() ;
	set ("light", 1) ;
	set ("short", "Meeting Room A") ;
	set ("long",
"This is meeting room A, in which structured discussion may be held.\n"+
...
"You can reach the conference center by typing 'out'.\n"
	...
	set_echo_room ("/d/Conf/room/spec_roomA") ;
	logfile = "room.A.log" ;
	votefile = "votes.A.log" ;
	call_other ("/d/Conf/boards/conf_A", "frog") ;
        call_other ("/d/Conf/obj/vendor_A", "frog") ;
}
